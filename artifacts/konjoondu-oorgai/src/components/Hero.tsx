...
import heroImg from '@assets/image_1784813124781.png';
import mobileHeroImg from '@assets/image_1784817039928.png';
// hero bg lives at attached_assets/ (@assets alias → workspace root attached_assets/)
...
export default function Hero() {
  ...
  return (
    <section
      ...
      style={{ background: '#0e0604' }}
    >
      {/* ── PARALLAX IMAGE — full image, no crop ── */}
      <motion.div
        className="hero-image-stage absolute inset-0 z-0 flex items-center justify-center"
        style={{
          y: imgY,
          '--mobile-hero-image': `url(${mobileHeroImg})`,
        } as any}
      >
        <img
          src={heroImg}
          alt="Konjoondu Oorgai product lineup with South Indian kitchen backdrop"
          className="w-full h-full object-contain object-center"
        />
      </motion.div>

      {/* Minimal left-side text-legibility gradient only */}
      <div
      ...
      {/* ── CONTENT ── */}
      <motion.div
        className="relative z-10 container mx-auto px-5 md:px-14 pt-24 sm:pt-28 pb-12 sm:pb-20 flex flex-col justify-between min-h-[100dvh]"
        style={{ y: textY }}
      >
        <div className="flex-1 flex flex-col justify-center max-w-3xl">
          ...
          <motion.p
            ...
            className="text-base md:text-xl max-w-lg mb-6 md:mb-10 leading-relaxed"
            style={{
          ...
          >
            ...
            <em style={{ fontStyle: 'normal', color: 'hsl(42,82%,68%)', fontWeight: 600 }}>
              prawn, fish, mutton & chicken pickles
            </em>
            {' '}— crafted from coastal family recipes, sun-cured spices, and pure love for non-veg.
          </motion.p>
          ...
          <motion.div
            ...
            className="flex flex-wrap gap-2.5 mb-6 md:mb-14"
          >
            {/* Primary */}
            <motion.a
              href="#products"
              ...
              whileTap={{ scale: 0.97 }}
              className="inline-flex items-center gap-2 px-5 md:px-7 h-11 md:h-14 rounded-full font-bold text-sm md:text-base cursor-pointer"
              style={{
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="inline-flex items-center gap-2 px-5 md:px-7 h-11 md:h-14 rounded-full font-semibold text-sm md:text-base cursor-pointer hidden sm:inline-flex"
              style={{
        ...
        <motion.div
          ...
          className="hidden sm:flex flex-col items-start gap-2 mt-10"
        >
          <span
