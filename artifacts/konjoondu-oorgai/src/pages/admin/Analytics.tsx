...
export default function Analytics({ orders, onRefresh }: Props) {
    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 22 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          {onRefresh && (
            <button onClick={onRefresh} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 14px', borderRadius: 10, border: '1.5px solid rgba(45,106,79,0.3)', background: 'transparent', color: '#2d6a4f', fontWeight: 700, fontSize: 13, cursor: 'pointer', fontFamily: 'inherit' }}>
