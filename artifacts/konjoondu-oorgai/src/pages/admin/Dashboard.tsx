...
import {
  ...
  CreditCard, Users, Star, Package, AlertTriangle, ArrowUpRight, ArrowDownRight, RefreshCw,
} from 'lucide-react';
import {
...
interface Props { orders: Order[]; token: string; onRefresh?: () => void }
...
export default function Dashboard({ orders, token, onRefresh }: Props) {
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24, flexWrap: 'wrap', gap: 10 }}>
        ...
        {onRefresh && (
          <button onClick={onRefresh} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '9px 16px', borderRadius: 10, border: '1.5px solid rgba(45,106,79,0.3)', background: 'transparent', color: '#2d6a4f', fontWeight: 700, fontSize: 13, cursor: 'pointer', fontFamily: 'inherit' }}>
